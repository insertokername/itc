        ...
        <header className="w-full sticky-nav" style={{position:"static"}}>
            <div className="flex flex-col flex-wrap max-w-5xl p-2.5 mx-auto md:flex-row">
                <div className="flex flex-row items-center justify-between p-2 md:p-1">
                    ...
                    >
                        <div class="relative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-slate-700 ring-0 ring-gray-300 hover:ring-8 group-hover:ring-4 ring-opacity-30 duration-200 shadow-md">
                            <div class="flex flex-col justify-between w-[20px] h-[20px] transform transition-all duration-300 origin-center overflow-hidden group-hover:-translate-x-1.5 group-hover:rotate-180">
                                <div class="bg-white h-[2px] w-7 transform transition-all duration-300 origin-left group-hover:rotate-[42deg] group-hover:w-2/3 delay-150"></div>
                                <div class="bg-white h-[2px] w-7 rounded transform transition-all duration-300 group-hover:translate-x-10"></div>
                                <div class="bg-white h-[2px] w-7 transform transition-all duration-300 origin-left group-hover:-rotate-[42deg] group-hover:w-2/3 delay-150"></div>
                            </div>
                        </div>
                    </button>
